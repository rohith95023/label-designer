...
const createElementsForTablet = (brand, comp, desc, dose) => [
  { id: uuidv4(), type: 'text', subtype: 'brand', text: brand, x: 20, y: 20, fontSize: 32, fontWeight: '800', color: '#191C1E', align: 'left', width: 400, height: 40 },
  { id: uuidv4(), type: 'subtext', text: 'Rx Only', x: 20, y: 65, fontSize: 10, fontWeight: '700', color: '#ffffff', bgColor: '#1976d2', align: 'left', width: 60, height: 18 },
  { id: uuidv4(), type: 'text', text: desc + '\n' + comp, x: 20, y: 90, fontSize: 14, fontWeight: '500', color: '#414752', align: 'left', width: 400, height: 60 },
  { id: uuidv4(), type: 'dosage', heading: 'Dosage', text: dose, x: 420, y: 20, fontSize: 16, fontWeight: '700', color: '#191C1E', align: 'right', width: 160, height: 60 },
  { id: uuidv4(), type: 'warnings', heading: 'Warnings', text: 'Store below 25°C.', x: 20, y: 160, fontSize: 11, fontWeight: '500', color: '#191c1e', alertColor: '#ba1a1a', align: 'left', width: 300, height: 40 },
  { id: uuidv4(), type: 'barcode', text: 'barcode', x: 480, y: 180, width: 100, height: 50 },
  { id: uuidv4(), type: 'expiry', heading: 'Expiry / Batch', text: 'EXP 11/26 | B.No 125B', x: 20, y: 300, fontSize: 12, fontWeight: '700', color: '#191c1e', align: 'left', width: 300, height: 40 }
];

const createElementsForSyrup = (brand, comp, desc, warn) => [
  { id: uuidv4(), type: 'text', subtype: 'brand', text: brand, x: 20, y: 20, fontSize: 32, fontWeight: '800', color: '#191C1E', align: 'left' },
  { id: uuidv4(), type: 'text', text: desc + '\n' + comp, x: 20, y: 70, fontSize: 14, fontWeight: '500', color: '#414752', align: 'left' },
  { id: uuidv4(), type: 'warnings', heading: 'Caution', text: warn, x: 20, y: 130, fontSize: 12, fontWeight: '700', color: '#ba1a1a', align: 'left' },
  { id: uuidv4(), type: 'barcode', text: 'barcode', x: 480, y: 200, width: 80, height: 40, color: '#1b6d24' }
];

const createElementsForInjection = (brand, comp, desc, route) => [
  { id: uuidv4(), type: 'text', subtype: 'brand', text: brand, x: 10, y: 10, fontSize: 24, fontWeight: '800', color: '#ba1a1a', align: 'left' },
  { id: uuidv4(), type: 'text', text: comp, x: 10, y: 45, fontSize: 12, fontWeight: '500', color: '#191C1E', align: 'left' },
  { id: uuidv4(), type: 'subtext', text: route, x: 10, y: 75, fontSize: 10, fontWeight: '700', color: '#ffffff', bgColor: '#1b6d24', align: 'left' },
  { id: uuidv4(), type: 'warnings', heading: 'For Hospital Use Only', text: 'Single dose vial', x: 300, y: 10, fontSize: 10, fontWeight: '700', color: '#191c1e', align: 'right' }
];

const createElementsForOintment = (brand, comp, desc, apply) => [
  { id: uuidv4(), type: 'text', subtype: 'brand', text: brand, x: 20, y: 20, fontSize: 28, fontWeight: '800', color: '#005dac', align: 'center', width: '100%' },
  { id: uuidv4(), type: 'text', text: desc + '\n' + comp, x: 20, y: 70, fontSize: 12, fontWeight: '500', color: '#414752', align: 'center', width: '100%' },
  { id: uuidv4(), type: 'manufacturing', heading: 'Directions', text: apply, x: 20, y: 130, fontSize: 12, fontWeight: '700', color: '#191C1E', align: 'center', width: '100%' }
];
...
const renderAllData = () => {
  ...
  tabletData.forEach((d, i) => {
    result.push({
      ...
      elements: createElementsForTablet(d.brand, d.comp, d.desc, d.dose)
    });
  });
  ...
  syrupData.forEach((d, i) => {
    result.push({
      ...
      size: '120 x 50 mm',
      image: Images.Syrups,
      elements: createElementsForSyrup(d.brand, d.comp, d.desc, d.warn)
    });
  });
  ...
  injectData.forEach((d, i) => {
    result.push({
      ...
      elements: createElementsForInjection(d.brand, d.comp, d.desc, d.route)
    });
  });
  ...
  ointData.forEach((d, i) => {
    result.push({
      ...
      elements: createElementsForOintment(d.brand, d.comp, d.desc, d.apply)
    });
  });
