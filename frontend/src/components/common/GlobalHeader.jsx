        ...
        <div className="relative">
          ...
          >
            <div className="flex flex-col items-end text-right hidden sm:flex">
                <span className="text-[11px] font-black text-white leading-none mb-0.5">{user?.username}</span>
                <span className="text-[9px] text-[var(--color-primary-light)] font-black uppercase tracking-widest opacity-80">{user?.role}</span>
            </div>
            <div className="w-8 h-8 rounded-full bg-[var(--color-primary-light)] flex items-center justify-center text-[var(--color-primary-dark)] font-black text-sm border-2 border-white/20 shadow-lg">
